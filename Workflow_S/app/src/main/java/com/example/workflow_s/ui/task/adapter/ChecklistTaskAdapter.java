...
public class ChecklistTaskAdapter extends RecyclerView.Adapter<ChecklistTaskAdapter.TaskViewHolder> {
    ...
    private ChecklistTaskFragment mChecklistTaskFragment;
    ...
    public ChecklistTaskAdapter(CheckboxListener listener, ChecklistTaskFragment checklistTaskFragment) {
        this.listener = listener;
        this.mChecklistTaskFragment = checklistTaskFragment;
    }
